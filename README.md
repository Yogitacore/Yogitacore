...
```typescript
const yogita = {
  title: "B.Tech AIML Student | Aspiring Software Developer / AI-ML Engineer",
  stack: [
    "Python", "C++", "Java", "HTML", "CSS",
    "Flask", "Streamlit", "Machine Learning", "NLP",
    "OpenCV", "REST APIs", "MySQL", "Firebase", "Supabase",
    "Git", "GitHub", "Azure", "Kaggle", "Hugging Face",
    "LM Studio", "GPT"
  ],
  launchedProjects: ["AI Spam Email Detector"],
  certifications: [],
  status: "B.Tech AIML Student",
  openTo: ["Software Developer Roles", "AI/ML Engineer Roles", "Internships", "Collaboration"]
};
```
